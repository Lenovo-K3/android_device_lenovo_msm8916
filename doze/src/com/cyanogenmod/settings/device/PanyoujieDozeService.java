...
public class PanyoujieDozeService extends Service {
    private static final String TAG = "PanyoujieDozeService";
    ...
    private PanyoujieProximitySensor mSensor;
    ...
    class PanyoujieProximitySensor implements SensorEventListener {
        ...
        public PanyoujieProximitySensor(Context context) {
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "PanyoujieDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new PanyoujieProximitySensor(mContext);
